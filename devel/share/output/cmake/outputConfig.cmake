...
if("TRUE" STREQUAL "TRUE")
  set(output_SOURCE_PREFIX /home/ozkahraman/catkin_ws/src/output)
  set(output_DEVEL_PREFIX /home/ozkahraman/catkin_ws/devel)
  set(output_INSTALL_PREFIX "")
  set(output_PREFIX ${output_DEVEL_PREFIX})
else()
  set(output_SOURCE_PREFIX "")
  set(output_DEVEL_PREFIX "")
  set(output_INSTALL_PREFIX /home/ozkahraman/catkin_ws/install)
...
if(NOT " " STREQUAL " ")
  ...
  foreach(idir ${_include_dirs})
    ...
    elseif("${idir} " STREQUAL "include ")
      ...
      message(FATAL_ERROR "Project 'output' specifies '${idir}' as an include dir, which is not found.  It does neither exist as an absolute directory nor in '/home/ozkahraman/catkin_ws/src/output/${idir}'.  ${_report}")
    endif()
...
foreach(library ${libraries})
  ...
  elseif(${library} MATCHES "^-")
    ...
    if(NOT output_NUM_DUMMY_TARGETS)
      set(output_NUM_DUMMY_TARGETS 0)
    endif()
    # Make sure the target name is unique
    set(interface_target_name "catkin::output::wrapped-linker-option${output_NUM_DUMMY_TARGETS}")
    while(TARGET "${interface_target_name}")
      math(EXPR output_NUM_DUMMY_TARGETS "${output_NUM_DUMMY_TARGETS}+1")
      set(interface_target_name "catkin::output::wrapped-linker-option${output_NUM_DUMMY_TARGETS}")
    endwhile()
    ...
    list(APPEND output_LIBRARIES "${interface_target_name}")
