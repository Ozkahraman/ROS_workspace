...
struct GorevDurumResult_
{
  ...
  (void)_alloc;
   ...
   typedef std::basic_string<char, std::char_traits<char>, typename std::allocator_traits<ContainerAllocator>::template rebind_alloc<char>> _sonuc_type;
  _sonuc_type sonuc;
...
struct Printer< ::ogretici_paket::GorevDurumResult_<ContainerAllocator> >
{
  ...
  {
    s << indent << "sonuc: ";
    Printer<std::basic_string<char, std::char_traits<char>, typename std::allocator_traits<ContainerAllocator>::template rebind_alloc<char>>>::stream(s, indent + "  ", v.sonuc);
  }
};
