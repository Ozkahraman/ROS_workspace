...
struct GorevDurumFeedback_
{
  ...
  (void)_alloc;
   ...
   typedef std::basic_string<char, std::char_traits<char>, typename std::allocator_traits<ContainerAllocator>::template rebind_alloc<char>> _oran_type;
  _oran_type oran;
...
struct Printer< ::ogretici_paket::GorevDurumFeedback_<ContainerAllocator> >
{
  ...
  {
    s << indent << "oran: ";
    Printer<std::basic_string<char, std::char_traits<char>, typename std::allocator_traits<ContainerAllocator>::template rebind_alloc<char>>>::stream(s, indent + "  ", v.oran);
  }
};
